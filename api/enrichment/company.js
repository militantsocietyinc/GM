 ...
 * - Clearbit-compatible domain lookup
 * - GitHub org data
...
/**
 * Fetch company data from GitHub org API (public, no key required)
 */
...
/**
 * Fetch tech stack hints from GitHub repos (languages used)
 */
...
/**
 * Fetch SEC EDGAR company filings (public API, no key)
 */
...
/**
 * Fetch Hacker News mentions for a company
 */
...
/**
 * Attempt to resolve domain → company info via DNS/whois-style heuristics
 */
