...
export class PanelLayoutManager implements AppModule {
    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="main-content">
        <div class="panels-grid" id="panelsGrid">
          <div class="map-section panel-wide span-2" id="mapSection" data-panel="map">
            ...
            <div class="panel-resize-handle" id="mapResizeHandle"></div>
  ...
  private createPanels(): void {
    ...
    const defaultOrder = Object.keys(DEFAULT_PANELS);
    const activePanelKeys = Object.keys(this.ctx.panelSettings);
