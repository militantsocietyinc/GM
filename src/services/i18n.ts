...
const SUPPORTED_LANGUAGES = ['en', 'cs', 'fr', 'de', 'el', 'es', 'it', 'pl', 'pt', 'nl', 'sv', 'ru', 'ar', 'he', 'zh', 'ja', 'ko', 'tr', 'th', 'vi'] as const;
...
export function getLocale(): string {
  ...
  const map: Record<string, string> = { en: 'en-US', cs: 'cs-CZ', el: 'el-GR', zh: 'zh-CN', pt: 'pt-BR', ja: 'ja-JP', ko: 'ko-KR', tr: 'tr-TR', th: 'th-TH', vi: 'vi-VN', he: 'he-IL' };
