...
- **RAG Failure Checklist** — structured troubleshooting guide for suspicious AI summaries, retrieval misses, and reasoning drift. [Details →](./docs/RAG_FAILURE_CHECKLIST.md)
