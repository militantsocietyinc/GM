// Generated from OpenFlights airlines.dat (public domain) via scripts/generate-airline-codes.mjs.
// Refresh quarterly with: node scripts/generate-airline-codes.mjs
...
const GENERATED = new Map<string, { iata: string; name: string }>([
  ...
  ["TGW", { iata: "TR", name: "Tiger Airways" }],
